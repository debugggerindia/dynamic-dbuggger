                        ...
                        <div className="col-xl-4 col-lg-4 col-md-7 col-sm-12">
                            <div className="footer-item-1">
                                ...
                                <p className="font-size-1-16">
                                    Shaping Designs, Powering Development, 
                                    <br />
                                    Fueling eCommerce Growth.
                                </p>
                                <span className="font-size-1-16">
                                    ...
                                    86 Cross Road HSR Layout, <br /> Bangalore,
                                    India
                                </span>
                                <span className="font-size-1-16">
                                    <svg
